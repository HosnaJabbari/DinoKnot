...
void printUsage(){
    ...
    printf ("Example:\n");
    printf ("./HFold_interacting_multimodel --s1 \"GCAACGAUGACAUACAUCGCUAGUCGACGC\" --r1 \"(____________________________)\" --s2 \"GCAACGAUGACAUACAUCGCUAGUCGACGCGCAACGAUGACAUACAUCGCUAGUCGACGC\" --r2 \"(__________________________________________________________)\" --t1 RNA --t2 DNA --shape \"shapefile\" --b -0.4 --m 1.3\n\n");
